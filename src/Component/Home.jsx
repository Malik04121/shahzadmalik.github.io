...
return(
    ...
    //   bgGradient='linear(to-t, #000000, #111E46)'
      ...
      direction={{ base: 'column-reverse', md: 'row-reverse',lg:'row' }} > 
        ...
        color="#002d5b" 
        >
         <Heading as="h2" fontSize={["1.5em","2.5em","3em"]} color="#ec5b53" >Hello, I'm</Heading>
         <Heading as="h3" fontSize={["2em","4.5em"]} color="#ec5b53"  >Shahzad Malik</Heading>
         <Typewriter
        options={{
          strings: [
            '<span style="font-size:1.8em;font-weight:bold" >A Full Stack Web Developer</span>', 
            '<span style="font-size: 1.8em;font-weight:bold">A MERN Stack Developer</span>'],
            // "A Full Stack Web Developer", "A MERN Stack Developer"],
          autoStart: true,
          loop: true,
          deleteSpeed: 80,
      ...
      />
         ...
         <Text color="black" mt="5%" fontSize={["md","md","xl"]}>I love to build website using the latest frond-end and backend technologies.</Text>
